...
class PermissionsTransactionManagerBase(SQLAlchemyTransactionManagerBase):
...
def get_permissions_unit_of_work(
    session: Annotated[AsyncSession, Depends(session_getter)],
) -> PermissionsTransactionManagerBase:
    return PermissionsTransactionManagerBase(session)
