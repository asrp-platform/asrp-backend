...
def get_use_case(
    ...
    return DeleteEmailTemplateUseCase(transaction_manager, email_service)


DeleteEmailTemplateUseCaseDep = Annotated[DeleteEmailTemplateUseCase, Depends(get_use_case)]
