...
async def insert_test_data(
    ...
    async with async_session() as session:
        session.add_all([
            ...
            Permission(action="memberships.view", name="View memberships"),
            Permission(action="memberships.delete", name="Delete memberships"),
            Permission(action="memberships.update", name="Update memberships"),
            Permission(action="membership_types.create", name="Create membership types"),
            Permission(action="membership_types.view", name="View membership types"),
            Permission(action="membership_types.delete", name="Delete membership types"),
            Permission(action="membership_types.update", name="Update membership types"),
            ...
            Permission(action="payments.create", name="Create payments"),
            Permission(action="payments.view", name="View payments"),
            Permission(action="payments.update", name="Update payments"),
            Permission(action="payments.delete", name="Delete payments"),
            ...
            Permission(action="webinars.create", name="Create webinars"),
            Permission(action="webinars.view", name="View webinars"),
            Permission(action="webinars.delete", name="Delete webinars"),
            Permission(action="webinars.update", name="Update webinars"),
            Permission(action="news.create", name="Create news"),
